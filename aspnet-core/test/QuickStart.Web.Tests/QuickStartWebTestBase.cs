...
{
    public abstract class QuickStartWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static QuickStartWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(QuickStartWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<QuickStartDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<QuickStartDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<QuickStartDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<QuickStartDbContext, Task<T>> func)
        {
            T result;
